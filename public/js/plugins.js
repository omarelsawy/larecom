...
(function (window, document, $, undefined) {
    ...
    D.ready(function () {
        ...
        H.addClass('fancybox-lock-customerApi');

        w2 = $(window).width();

        H.removeClass('fancybox-lock-customerApi');
...
(function (s, H, f, w) {
    ...
    p.ready(function () {
        ...
        a = f(s).width();
        K.addClass("fancybox-lock-customerApi");
        d = f(s).width();
        K.removeClass("fancybox-lock-customerApi");
